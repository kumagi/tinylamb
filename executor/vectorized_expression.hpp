...
class VectorizedExpression {
 public:
  ...
  static StatusOr<ColumnVector> Evaluate(const Expression& expr,
                                         const Schema& schema,
  ...
  static StatusOr<ValidityBitmap> EvaluateFilter(
  ...
  static Status FilterDataChunk(const Expression& expr, const Schema& schema,
                                const DataChunk& chunk,
