...
struct ExprGenConfig {
  ...
  int null_percent = 15;
  // If true, generate extended operations (bitwise, string functions, IS
  // DISTINCT FROM). Kept false by default to preserve deterministic RNG replay
  // of pinned test cases.
